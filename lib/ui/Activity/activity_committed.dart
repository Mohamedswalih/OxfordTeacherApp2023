...
class ActivityCommitted extends StatefulWidget {
  String? LoginedInEmployeeCode;

  ActivityCommitted({Key? key, this.LoginedInEmployeeCode}) : super(key: key);

  @override
  _ActivityCommittedState createState() => _ActivityCommittedState();
}

class _ActivityCommittedState extends State<ActivityCommitted> {
