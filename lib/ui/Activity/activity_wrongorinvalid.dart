...
class ActivityWrongNumber extends StatefulWidget {
  String? LoginedInEmployeeCode;
  ActivityWrongNumber({Key? key, this.LoginedInEmployeeCode}) : super(key: key);

  @override
  _ActivityWrongNumberState createState() => _ActivityWrongNumberState();
}

class _ActivityWrongNumberState extends State<ActivityWrongNumber> {
