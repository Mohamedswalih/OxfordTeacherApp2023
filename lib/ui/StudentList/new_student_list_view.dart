 ...
 List<Map> latestudents = [];
  ...
  Future getStudentAttendanceList() async {
    ...
    if (response.statusCode == 200) {
      ...
      log('std list-------->${jsonResponse}->>>>endddddd');
      setState(() {
  ...
  Future SubmitAttendance(List<dynamic> late) async {
    ...
    if (response.statusCode == 200) {
      ...
      print('----reasonnn${response.statusCode}');
      Utils.showToastSuccess("Something Went Wrong").show(context);
      setState(() {
        newSpinner = false;
      });
      // print('------------<<<absent>>>>>>><<<>>><><><><><$')
  ...
  // studentActivities(String admissionNumber) async {
  //   studentFeedbacknull = true;
  ...
  //       studentFeedbacknull = false;
  //     });
  //     print(studentFeebackList);
  //   } else {
  //     print(response.reasonPhrase);
  //   }
  // }
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      isStudentListnull.isEmpty || isStudentListnull == null
                          ? Expanded(
